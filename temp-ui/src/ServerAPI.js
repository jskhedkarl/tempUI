class StatsEginx {
    ...
    static SimulateObj() {
        ...
        return this(activeConnection, totalConnection, totalHandledConnection, totalRequests, 0, 0, 0, 0);
    }
}
...
class StatsCPU {
    ...
    static SimulateObj() {
        ...
        let irq = 0;
        return this(user, nice, system, idle, iowait, irq);
    }
}
